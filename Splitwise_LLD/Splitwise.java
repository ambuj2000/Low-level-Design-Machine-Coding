...
import Splitwise_LLD.Group.Group;
import Splitwise_LLD.Group.GroupController;
import Splitwise_LLD.User.User;
import Splitwise_LLD.User.UserController;
...
public class Splitwise {
    ...
    private void addUsersToSplitwiseApp(){
        ...
        //adding User1
        User user1 = new User("U1001", "Aditya");

        //adding User2
        User user2 = new User ("U2001", "Divyansh");

        //adding User3
        User user3 = new User("U3001", "Raj");
